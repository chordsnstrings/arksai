...
const ITEMS: { title: string; body: string }[] = [
  {
    title: 'A warmer welcome back',
    body: 'ArksAI now greets you by name and time of day — and you can set what it calls you. (Just chat: no modes to pick, it plans before it builds, and picking a team readies its skills.)',
  },
  {
