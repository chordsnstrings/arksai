...
export const DEPARTMENTS: Department[] = [
  {
    ...
    plays: [
      ...
      { key: 'marketing.storyad', title: 'Story video ad', blurb: 'Multi-scene ad, stitched into one film.', mode: 'chat', model: A, category: 'create', icon: 'image',
        prompt: 'Create a multi-scene story VIDEO ad for my product: plan the scene flow from my description (an opening hook, the product moment, the payoff), keep the product and any on-screen text consistent across scenes, and stitch it into one film. Ask me for the story (what happens, in order), the platform (vertical Reels/TikTok or landscape), and any product photo or exact on-screen text first — then show me the scene plan and a cheap stitched draft before the final.' },
