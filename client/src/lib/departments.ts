...
export const DEPARTMENTS: Department[] = [
  {
    ...
    plays: [
      ...
      { key: 'marketing.creative', title: 'Ad & social creative', blurb: 'AI images with crisp text.', mode: 'code', model: A, category: 'create', icon: 'image',
        prompt: 'Create a set of finished, ready-to-post marketing creatives: an AI-generated on-brand background with my headline, subhead, and call-to-action laid on as crisp, perfectly-legible text — sized per channel (square 1:1, portrait 4:5, story 9:16, wide 16:9). Tell me the product, the vibe, and a colour, and upload your logo if you want it on them; I’ll generate the images and hand you the downloadable files.' },
