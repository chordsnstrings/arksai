...
export const DEPARTMENTS: Department[] = [
  {
    ...
    plays: [
      ...
      { key: 'marketing.emailkit', title: 'Email + social kit', blurb: 'On-brand assets to send.', mode: 'code', model: A, category: 'create', icon: 'mail',
        prompt: 'Design a small launch kit: a responsive HTML marketing email and three on-brand social post graphics — generate the visuals as real images with AI image generation (not grey placeholders). Ask me for the product, the headline, and a colour, then build them.' },
      { key: 'marketing.creative', title: 'Ad & social creative', blurb: 'AI-generated on-brand images.', mode: 'code', model: A, category: 'create', icon: 'image',
        prompt: 'Generate a set of on-brand marketing visuals with AI image generation: a hero/ad image plus a few social post graphics sized per channel (square 1:1, story 9:16, wide 16:9). Tell me the product, the vibe, and a colour — I’ll generate the images, lay them out on a clean board, and hand you the downloadable files.' },
